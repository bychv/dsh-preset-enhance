 ...
 * self-contained (no @deepseek-ai/* imports) — LlmError comes from the vendored
 * ./errors.mjs and attribution headers from the plugin-owned ./config.mjs.
 */

import { attributionHeaders } from './config.mjs';
import { LlmError } from './errors.mjs';
import { DeepSeekFileId } from './file-id.mjs';
import type { DeepSeekFileId as DeepSeekFileIdType } from './file-id.mjs';
import { MESSAGES_FILES_BETA, messagesApiRoot } from './messages-api.mjs';
import type { DeepSeekProtocol } from './messages-api.mjs';
import type { ImageMediaType } from './host-types.mjs';
